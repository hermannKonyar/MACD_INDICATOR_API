...
def get_macd_data():
    ...
    for symbol in symbols:
        for interval in intervals:
            ...
            if previous_macd < previous_macdsignal and current_macd > current_macdsignal and current_macd<0 and previous_macd<0:
                signal = 'BUY'
            elif previous_macd > previous_macdsignal and current_macd < current_macdsignal and current_macd>0 and previous_macd>0:
                signal = 'SELL'
            else:
                signal = ''
